...
set output "cumulative_new_critical.png"
set title "cumulative_new_critical"
plot "cumulative_new_critical.csv" using 1:2 with lines
set output "cumulative_new_deaths.png"
set title "cumulative_new_deaths"
plot "cumulative_new_deaths.csv" using 1:2 with lines
set output "cumulative_new_detected.png"
set title "cumulative_new_detected"
plot "cumulative_new_detected.csv" using 1:2 with lines
set output "cumulative_new_exposed.png"
set title "cumulative_new_exposed"
plot "cumulative_new_exposed.csv" using 1:2 with lines
set output "cumulative_new_hospitalised.png"
set title "cumulative_new_hospitalised"
plot "cumulative_new_hospitalised.csv" using 1:2 with lines
set output "cumulative_new_presymptomatic.png"
set title "cumulative_new_presymptomatic"
plot "cumulative_new_presymptomatic.csv" using 1:2 with lines
set output "cumulative_new_recovered.png"
set title "cumulative_new_recovered"
plot "cumulative_new_recovered.csv" using 1:2 with lines
set output "cumulative_new_symptomatic.png"
set title "cumulative_new_symptomatic"
plot "cumulative_new_symptomatic.csv" using 1:2 with lines
set output "daily_new_critical.png"
set title "daily_new_critical"
plot "daily_new_critical.csv" using 1:2 with lines
set output "daily_new_deaths.png"
set title "daily_new_deaths"
plot "daily_new_deaths.csv" using 1:2 with lines
set output "daily_new_detected.png"
set title "daily_new_detected"
plot "daily_new_detected.csv" using 1:2 with lines
set output "daily_new_exposed.png"
set title "daily_new_exposed"
plot "daily_new_exposed.csv" using 1:2 with lines
set output "daily_new_hospitalised.png"
set title "daily_new_hospitalised"
plot "daily_new_hospitalised.csv" using 1:2 with lines
set output "daily_new_presymptomatic.png"
set title "daily_new_presymptomatic"
plot "daily_new_presymptomatic.csv" using 1:2 with lines
set output "daily_new_recovered.png"
set title "daily_new_recovered"
plot "daily_new_recovered.csv" using 1:2 with lines
set output "daily_new_symptomatic.png"
set title "daily_new_symptomatic"
plot "daily_new_symptomatic.csv" using 1:2 with lines
set output "total_detected_cases.png"
set title "total_detected_cases"
plot "total_detected_cases.csv" using 1:2 with lines
