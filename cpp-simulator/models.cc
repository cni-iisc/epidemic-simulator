...
double agent::get_attendance_probability(count_type time) const{
  ...
  if(!GLOBAL.CYCLIC_POLICY_ENABLED || day < GLOBAL.CYCLIC_POLICY_START_DAY){
    ...
    auto cyclic_period = (day / GLOBAL.PERIOD_OF_ATTENDANCE_CYCLE) % GLOBAL.NUMBER_OF_CYCLIC_CLASSES;
