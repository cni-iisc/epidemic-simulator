...
struct global_params{
  ...
  count_type daily_new_exposed = 0;
  count_type daily_new_presymptomatic = 0;
  count_type daily_new_symptomatic = 0;
  count_type daily_new_hospitalised = 0;
  count_type daily_new_critical = 0;
  count_type daily_new_recovered = 0;
  count_type daily_new_deaths = 0;
  count_type daily_new_detected = 0;

  // Cumulative counters
  count_type cumulative_new_exposed = 0;
  count_type cumulative_new_presymptomatic = 0;
  count_type cumulative_new_symptomatic = 0;
  count_type cumulative_new_hospitalised = 0;
  count_type cumulative_new_critical = 0;
  count_type cumulative_new_recovered = 0;
  count_type cumulative_new_deaths = 0;
  count_type cumulative_new_detected = 0;

  // Detection tracking
  // count_type num_affected_count = 0;
