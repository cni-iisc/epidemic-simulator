...
plt.plot(dBangalore_time, dBangalore_h,'ro-', label='Bengaluru cases')
...
fill_start_index = 0 #(offset+num_days_after_fill)*4; #fill starts 20 days after March 1
for intvIdx in range (0,len(intvStr)):
...
print("max fatalities NI Bangalore= ", max_fatalities_NI,". max fatalities NI Bangalore std = ", max_fatalities_NI_std)
print("max fatalities LD Bangalore= ", max_fatalities_LD,". max fatalities LD Bangalore std = ", max_fatalities_LD_std)
